<%-- Document : addpost Created on : Oct 19, 2023, 10:51:46 AM Author : HP ADMIN --%>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="post-container">
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label">What are you
                                            thinking?</label>
                                        <textarea class="form-control" id="caption" name="caption" rows="3"
                                            placeholder="Write some caption..."></textarea>
                                        <small id="caption-error" class="text-danger"></small>
                                    </div>
                                </div>
                                <div class="mb-3">
